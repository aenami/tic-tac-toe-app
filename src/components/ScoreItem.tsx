...
function ScoreItem({ id }: ScoreId) {
  ...
  const scoreConfig:Record<number, { score: number, Icon:React.ReactNode, text:string }> = {
    0: { score: state.scores.xScore , Icon: <BsXSquareFill size={40} color='#504cc5'/>, text:'Player X'},
    1: { score: state.scores.oScore, Icon: <MdOutlineCircle size={40} color='#fa5c87'/>, text:'Player O'},
    2: { score: state.scores.drawScore, Icon: <LuCircleEqual size={40} color='#fdc73a'/>, text:'Draw'},
  }
